...
if (is_post()) {
    ...
    if (
        ...
        $statement = $pdo->prepare("INSERT INTO admins (username, password, email, fullName, staffID, centreName) 
        VALUES (:username, :password, :email, :fullName, :staffID, :centreName)");
